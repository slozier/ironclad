...
#else
#ifndef IRONCLAD // mingw defines this already
...
#endif*/
#ifdef HAVE_CHOWN // added for IRONCLAD, should maybe be here anyway?
...
#ifdef IRONCLAD // make long long constant really a long long
